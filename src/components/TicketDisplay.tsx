...
const TicketCard: React.FC<{ ticket: Ticket }> = ({ ticket }) => {
  ...
  return (
    <div className="bg-slate-800/50 border border-slate-700 rounded-xl overflow-hidden hover:border-slate-600 transition-all duration-200 hover:shadow-lg hover:shadow-slate-900/20">
      {/* Header */}
  ...
  return (
    <div className="border-b border-slate-700/50 pb-3 mb-3 last:border-b-0 last:mb-0 last:pb-0">
      ...
      <div className="space-y-1">
        ...
        <p className="text-slate-500 text-xs italic line-clamp-2">
          {match.reasoning}
        </p>
      </div>
    </div>
